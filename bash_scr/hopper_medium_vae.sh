...
DYNAMICS_PATHS[42]="log/hopper-medium-v2/mobile_gormpo&penalty_coef=1.5&rollout_length=5&classifier_type=diffusion/seed_42&timestamp_26-0323-063826/model"
DYNAMICS_PATHS[123]="log/hopper-medium-v2/mobile_gormpo&penalty_coef=1.5&rollout_length=5&classifier_type=diffusion/seed_123&timestamp_26-0324-031543/model"
DYNAMICS_PATHS[456]="log/hopper-medium-v2/mobile_gormpo&penalty_coef=1.5&rollout_length=5&classifier_type=diffusion/seed_456&timestamp_26-0324-225205/model"
...
do
    ...
    python train.py \
    --device $DEVICE \
    --config config_gormpo/hopper_medium_vae.yaml \
    --seed $seed \
    --classifier_model_name /public/gormpo/models/hopper_medium/vae_123 \

...
do
    ...
    --device $DEVICE \
    --config config_gormpo/halfcheetah_medium_expert_72.5_realnvp.yaml \
    --seed $seed \
    --epoch 3000 \
    --reward_penalty_coef 0.8 \
    --task $TASK \
    --classifier_model_name /public/gormpo/models/halfcheetah_medium_expert_sparse_3/realnvp \

...
do
    ...
    --device $DEVICE \
    --config config_gormpo/walker2d_medium_expert_72.5_vae.yaml \
    --seed $seed \
    --epoch 3000 \
    --reward_penalty_coef 0.7 \
    --task $TASK \
    --classifier_model_name /public/gormpo/models/walker2d_medium_expert_sparse_3/vae \

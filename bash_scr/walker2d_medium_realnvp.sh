...
DYNAMICS_PATHS[42]="log/walker2d-medium-v2/mobile_gormpo&penalty_coef=0.5&rollout_length=5&classifier_type=diffusion/seed_42&timestamp_26-0323-064004/model"
DYNAMICS_PATHS[123]="log/walker2d-medium-v2/mobile_gormpo&penalty_coef=0.5&rollout_length=5&classifier_type=diffusion/seed_123&timestamp_26-0324-054858/model"
DYNAMICS_PATHS[456]="log/walker2d-medium-v2/mobile_gormpo&penalty_coef=0.5&rollout_length=5&classifier_type=diffusion/seed_456&timestamp_26-0325-020200/model"
...
do
    ...
    python train.py \
    --device $DEVICE \
    --config config_gormpo/walker2d_medium_realnvp.yaml \
    --seed $seed \
    --classifier_model_name /public/gormpo/models/walker2d/realnvp \
